...
namespace grafica
{
    class Octaeder
    {
        public static void Draw(Vector3 center)
        {
            ...
            DrawFirst2(drawMode, clr2, center);
            DrawSecond2(drawMode, clr3, center);
            DrawThird2(drawMode, clr4, center);
            DrawFourth2(drawMode, clr5, center);
        }
        ...
        private static void DrawFirst2(BeginMode drawMode, Vector3 clr3, Vector3 point)
        {
            GL.Begin(drawMode);
        ...
        private static void DrawSecond2(BeginMode drawMode, Vector3 clr3, Vector3 point)
        {
            GL.Begin(drawMode);
        ...
        private static void DrawThird2(BeginMode drawMode, Vector3 clr3, Vector3 point)
        {
            GL.Begin(drawMode);
        ...
        private static void DrawFourth2(BeginMode drawMode, Vector3 clr3, Vector3 point)
        {
            GL.Begin(drawMode);
            GL.Color3(clr3);
            GL.Vertex3(-100.0f + point.X, 100.0f + point.Y, -100.0f + point.Z);
