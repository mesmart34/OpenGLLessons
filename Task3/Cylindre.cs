...
namespace grafica
{
    public class Cylindre
    {
        ...
        private static void DrawBottom(BeginMode drawMode, Vector3[] points, Vector3 clr3)
        {
            GL.Begin(drawMode);
        ...
        private static void DrawSides(Vector3[] points, Vector3[] upPoints, BeginMode drawMode, Vector3 clr3)
        {
        ...
        private static void DrawSide(Vector3 first1, Vector3 second1, Vector3 first2, Vector3 second2,
            BeginMode drawMode, Vector3 clr3)
        {
            GL.Begin(drawMode);
